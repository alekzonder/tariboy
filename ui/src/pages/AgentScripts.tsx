...
export default function AgentScripts() {
  ...
  const rerun = async (definition: ScriptDefinition) => {
    ...
    catch (error) { toast.error(`Could not execute script: ${errorText(error)}`); }
  };
