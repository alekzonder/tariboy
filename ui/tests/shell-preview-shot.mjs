...
await page.goto('http://127.0.0.1:4175/tests/shell-preview.html' + '?route=' + encodeURIComponent(route ?? '/agents/local/builder/console') + (theme ? '&theme=' + theme : ''), { waitUntil: 'networkidle' });
