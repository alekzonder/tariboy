...
The Judge page can create the fixed `judges` group when it is missing. It uses
the selected server's applied automation configuration for the group lead and
assigns that lead plus both configured workers as members.
