...
alarms. Only **Chat** has a composer; the other two are the agent's feeds, and
the customer is an observer in the service one. A task key in any of them is
...
The tab has one 48px toolbar: the **Chat**/**Channels** switch, the three-chat
