...
```text
dist/releases/0.62.3/
  Tariboy_0.62.3_aarch64.dmg
  SHA256SUMS
  release.json
```
...
```bash
scripts/check-alpha-artifacts.sh dist/releases/0.62.3
```
...
```bash
git tag -a v0.62.3 -m 'Tariboy 0.62.3'
git push origin v0.62.3
```
