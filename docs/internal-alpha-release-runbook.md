...
```text
dist/releases/0.68.0/
  Tariboy_0.68.0_aarch64.dmg
  tariboy_0.68.0_linux-x86_64.tar.gz
  SHA256SUMS
  release.json
```
...
```bash
scripts/check-alpha-artifacts.sh dist/releases/0.68.0
```
...
```bash
git tag -a v0.68.0 -m 'Tariboy 0.68.0'
