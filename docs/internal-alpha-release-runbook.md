...
```text
dist/releases/0.65.0/
  Tariboy_0.65.0_aarch64.dmg
  tariboy_0.65.0_linux-x86_64.tar.gz
  SHA256SUMS
  release.json
```
...
```bash
scripts/check-alpha-artifacts.sh dist/releases/0.65.0
```
...
```bash
git tag -a v0.65.0 -m 'Tariboy 0.65.0'
