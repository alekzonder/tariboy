...
```text
dist/releases/0.67.0/
  Tariboy_0.67.0_aarch64.dmg
  tariboy_0.67.0_linux-x86_64.tar.gz
  SHA256SUMS
  release.json
```
...
```bash
scripts/check-alpha-artifacts.sh dist/releases/0.67.0
```
...
```bash
git tag -a v0.67.0 -m 'Tariboy 0.67.0'
