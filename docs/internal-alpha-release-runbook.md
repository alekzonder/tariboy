...
```text
dist/releases/0.66.2/
  Tariboy_0.66.2_aarch64.dmg
  tariboy_0.66.2_linux-x86_64.tar.gz
  SHA256SUMS
  release.json
```
...
```bash
scripts/check-alpha-artifacts.sh dist/releases/0.66.2
```
...
```bash
git tag -a v0.66.2 -m 'Tariboy 0.66.2'
git push origin v0.66.2
```
