...
```text
dist/releases/0.66.1/
  Tariboy_0.66.1_aarch64.dmg
  tariboy_0.66.1_linux-x86_64.tar.gz
  SHA256SUMS
  release.json
```
...
```bash
scripts/check-alpha-artifacts.sh dist/releases/0.66.1
```
...
```bash
git tag -a v0.66.1 -m 'Tariboy 0.66.1'
